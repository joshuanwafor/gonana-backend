...
export class UserCtrl {
  ...
  async getTransactions(): Promise<TransactionModel[]> {
    const list = await this.transactionsService.getUserTransactions(
      this.authService.user_id
    );
    return list;
  }
